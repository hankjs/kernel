...
namespace HookKeyboard
{
    ...
    LRESULT CALLBACK HookProcedure(int nCode, WPARAM wParam, LPARAM lParam)
    {
        ...
        if (nCode == HC_ACTION)
        {
            // Message data is ready for pickup
            // Check for SHIFT key
            ...
            //  Start Logging keys now we are setup
        ...
        // Napi::Env env = HookEnv;

        // Napi::Object data = Napi::Object::New(env);
        // data["type"] = Napi::Number::New(env, wParam);

        // Napi::Object event = Napi::Object::New(env);

        // data["event"] = event;

        // event["vkCode"] = Napi::Number::New(env, p->vkCode);
        // event["scanCode"] = Napi::Number::New(env, p->scanCode);
        // event["flags"] = Napi::Number::New(env, p->flags);
        // event["time"] = Napi::Number::New(env, p->time);

        // HookCallBack.Call({Napi::String::New(env, "data"), data});
